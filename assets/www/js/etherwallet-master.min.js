...
lastDataFromTrans = "Sent from Simple Etherium Wallet (Android) with no data";
...
var fromAscii3 = function(str, padding) {
    var hex = '0x';
...
function createTransaction(e, t, r, a, n) {
    ...
    //alert('here');
    //var transformedD = fromAscii3(lastDataFromTrans);
  //  alert(transformedD );
