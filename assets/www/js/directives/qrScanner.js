...
angular.module('copayApp.directives')
    .directive('qrScanner', ['$rootScope', '$timeout', '$modal', 'isDevice', 'gettextCatalog', 'isMobile', 
      function($rootScope, $timeout, $modal, isDevice, gettextCatalog, isMobile) {
