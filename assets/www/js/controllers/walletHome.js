...
angular.module('copayApp.controllers').controller('walletHomeController', 
  ...
  this.bindTouchDown = function(tries) {
    ...
    ['hamburger', 'menu-walletHome', 'menu-send', 'menu-receive', 'sendBut','camera-icon', 'prefBut1', 'prefBut2', 'closeBut', 'backBut'].forEach(function(id) {
